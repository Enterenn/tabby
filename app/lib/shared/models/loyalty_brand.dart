...
class LoyaltyBrand {
  ...
  static const List<LoyaltyBrand> catalog = [
    ...
    LoyaltyBrand(
      id: 'leclerc',
      name: 'E.Leclerc',
      primary: Color(0xFF006DCA),
      secondary: Color(0xFFFF5E2E),
      monogram: 'E',
    ...
    LoyaltyBrand(
      id: 'jardiland',
      name: 'Jardiland',
      primary: Color(0xFFE25205),
      secondary: Color(0xFFC44404),
      monogram: 'J',
    ...
    LoyaltyBrand(
      id: 'truffaut',
      name: 'Truffaut',
      primary: Color(0xFF136A55),
      secondary: Color(0xFF0E5342),
      monogram: 'T',
    ...
    LoyaltyBrand(
      id: 'botanic',
      name: 'Botanic',
      primary: Color(0xFF8DC63F),
      secondary: Color(0xFF6F9E2C),
      monogram: 'B',
      onPrimary: Color(0xFF1A1A1A),
    ...
    LoyaltyBrand(
      id: 'gammvert',
      name: 'Gamm Vert',
      primary: Color(0xFF0E664E),
      secondary: Color(0xFF0A4E3B),
      monogram: 'GV',
    ...
    LoyaltyBrand(
      id: 'aldi',
      name: 'Aldi',
      primary: Color(0xFF001F78),
      secondary: Color(0xFFFA6E0A),
      monogram: 'A',
    ...
    LoyaltyBrand(
      id: 'kiabi',
      name: 'Kiabi',
      primary: Color(0xFF0053A0),
      secondary: Color(0xFF4B90CD),
      monogram: 'K',
